...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_kewaspadaan_transmisi WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_kewaspadaan_transmisi_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Kewaspadaan Transmisi</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Kewaspadaan Transmisi #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit kewaspadaan transmisi.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_kewaspadaan_transmisi.php?tab=tab-data">Kembali ke Data</a>
