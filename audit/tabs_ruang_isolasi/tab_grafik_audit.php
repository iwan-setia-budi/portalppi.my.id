...
$judulGrafik = 'Grafik Kepatuhan Ruang Isolasi di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Ruang Isolasi di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
...
<div id="tab-grafik" class="tab-pane active">
  ...
  <div class="section-card">
    ...
    <div class="chart-wrap" id="grafikRuangIsolasiExportWrap">
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', async function () {
        const wrap = document.getElementById('grafikRuangIsolasiExportWrap');
        ...
        try {
          ...
          const out = await html2canvas(wrap, {
            ...
            onclone: function (doc) {
              const w = doc.getElementById('grafikRuangIsolasiExportWrap');
              if (w) {
                w.style.borderRadius = '14px';
                w.style.background = '#ffffff';
              }
              const kk = doc.querySelector('#grafikRuangIsolasiExportWrap .kode-keterangan-wrap');
              if (kk) {
