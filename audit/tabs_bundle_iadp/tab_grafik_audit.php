...
$judulGrafik = 'Grafik Kepatuhan Bundle IADP di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Bundle IADP di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
...
<div id="tab-grafik" class="tab-pane active">
  ...
  <div class="section-card">
    ...
    <div class="chart-wrap" id="grafikBundleIadpExportWrap">
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', async function () {
        const wrap = document.getElementById('grafikBundleIadpExportWrap');
        ...
        try {
          ...
          const out = await html2canvas(wrap, {
            ...
            onclone: function (doc) {
              const w = doc.getElementById('grafikBundleIadpExportWrap');
              if (w) {
                w.style.borderRadius = '14px';
                w.style.background = '#ffffff';
              }
              const kk = doc.querySelector('#grafikBundleIadpExportWrap .kode-keterangan-wrap');
              if (kk) {
