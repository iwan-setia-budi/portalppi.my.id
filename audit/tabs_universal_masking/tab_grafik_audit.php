...
$judulGrafik = 'Grafik Kepatuhan Audit Universal Masking di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Audit Universal Masking di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', function () {
        ...
        link.download = 'grafik-kepatuhan-universal-masking.png';
        link.click();
      });
    }
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-universal-masking.png';
        link.click();
      });
    }
  })();
