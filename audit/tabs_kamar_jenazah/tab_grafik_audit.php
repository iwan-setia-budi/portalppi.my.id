...
$judulGrafik = 'Grafik Kepatuhan Audit Kamar Jenazah di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Audit Kamar Jenazah di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
  ...
  (function () {
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-kamar-jenazah.png';
        link.click();
      });
    }
  })();
