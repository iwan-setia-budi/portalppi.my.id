...
$judulGrafik = 'Grafik Kepatuhan Audit Targeted Continuous Medical Mask Use di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Audit Targeted Continuous Medical Mask Use di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', function () {
        ...
        link.download = 'grafik-kepatuhan-targeted-continuous-medical-mask-use.png';
        link.click();
      });
    }
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-targeted-continuous-medical-mask-use.png';
        link.click();
      });
    }
  })();
