...
<div id="tab-data" class="tab-pane active">
    ...
    <form method="get">
      ...
      <div class="filter-grid">
        <div class="search-wrap">
          ...
          <input type="text" name="keyword_data" class="form-control" placeholder="Cari petugas, catatan, atau ruangan" value="<?= htmlspecialchars($keywordData) ?>">
        </div>
  ...
  <div class="section-card">
    <h3 class="card-title">Data Audit Targeted Continuous Medical Mask Use</h3>
              ...
              <tr>
                ...
                <td class="center">
                  <div class="action-group">
                    <a class="icon-btn view" href="crud_targeted_continuous_medical_mask_use/detail_audit.php?id=<?= (int) $row['id'] ?>" title="Lihat detail" aria-label="Lihat detail">👁</a>
                    <a class="icon-btn edit" href="crud_targeted_continuous_medical_mask_use/edit_audit.php?id=<?= (int) $row['id'] ?>" title="Edit data" aria-label="Edit data">✏</a>
                    <a class="icon-btn del" href="crud_targeted_continuous_medical_mask_use/hapus_audit.php?id=<?= (int) $row['id'] ?>" title="Hapus data" aria-label="Hapus data" onclick="return confirm('Yakin hapus data ini?')">🗑</a>
                  </div>
                </td>
              </tr>
            <?php endforeach; ?>
        ...
        <div class="mobile-list">
          <?php foreach ($rowsData as $row): ?>
            ...
            <div class="mobile-item">
              ...
              <div class="mobile-meta"><?= htmlspecialchars($row['ruangan_diaudit'] ?? '') ?> · <?= htmlspecialchars($row['nama_petugas_unit']) ?></div>
              <div class="score-wrap">
                <div class="score-head">
              ...
              <div class="mobile-actions">
                <a class="icon-btn view" href="crud_targeted_continuous_medical_mask_use/detail_audit.php?id=<?= (int) $row['id'] ?>" title="Lihat detail">👁</a>
                <a class="icon-btn edit" href="crud_targeted_continuous_medical_mask_use/edit_audit.php?id=<?= (int) $row['id'] ?>" title="Edit data">✏</a>
                <a class="icon-btn del" href="crud_targeted_continuous_medical_mask_use/hapus_audit.php?id=<?= (int) $row['id'] ?>" title="Hapus data" onclick="return confirm('Yakin hapus data ini?')">🗑</a>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
    ...
    <?php else: ?>
      <div class="empty-state">
        ...
        <strong>Belum ada data audit targeted continuous medical mask use.</strong>
