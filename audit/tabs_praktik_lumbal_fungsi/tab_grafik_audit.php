...
$judulGrafik = 'Grafik Kepatuhan Audit Praktik Lumbal Fungsi di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Audit Praktik Lumbal Fungsi di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', function () {
        ...
        link.download = 'grafik-kepatuhan-praktik-lumbal-fungsi.png';
        link.click();
      });
    }
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-praktik-lumbal-fungsi.png';
        link.click();
      });
    }
  })();
