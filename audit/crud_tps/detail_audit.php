...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_tps WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_tps_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit TPS #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit TPS.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_tps.php?tab=tab-data">Kembali ke Data</a>
