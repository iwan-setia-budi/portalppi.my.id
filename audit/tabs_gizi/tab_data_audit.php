<style>
  #tab-data .data-title { margin: 0 0 12px; font-size: 28px; font-weight: 900; letter-spacing: -0.2px; }
  #tab-data .card-title { margin: 0 0 12px; font-size: 22px; font-weight: 900; }
  #tab-data .filter-grid { display:grid; grid-template-columns:2fr 1fr 1fr auto; gap:12px; align-items: center; }
  ...
  #tab-data table { width:100%; border-collapse:separate; border-spacing:0 6px; padding: 0 10px 8px; }
  #tab-data thead th {
  ...
  #tab-data tbody tr:hover { transform: translateY(-2px); }
  #tab-data td {
    background: var(--card); border-top:1px solid var(--line); border-bottom:1px solid var(--line);
    padding: 14px 12px; vertical-align: middle; transition: all .2s ease;
  }
  #tab-data td:first-child { border-left:1px solid var(--line); border-top-left-radius: 12px; border-bottom-left-radius: 12px; }
  #tab-data td:last-child { border-right:1px solid var(--line); border-top-right-radius: 12px; border-bottom-right-radius: 12px; }
  #tab-data tbody tr:nth-child(even) td { background: color-mix(in srgb, var(--card) 94%, #e2e8f0 6%); }
  #tab-data tbody tr:hover td { box-shadow: 0 8px 18px rgba(15, 23, 42, 0.09); background: #f8fafc; }
  #tab-data .center { text-align:center; }
  #tab-data .score-wrap { min-width: 210px; }
  #tab-data .score-head { display:flex; align-items:center; justify-content:flex-start; gap:8px; margin-bottom:8px; font-size:12px; font-weight:800; }
  #tab-data .score-main { font-size: 16px; font-weight: 900; color: #0f172a; letter-spacing: -.2px; line-height: 1; }
  #tab-data .score-pill {
  ...
  #tab-data .score-bar { height: 8px; border-radius: 999px; background: #e2e8f0; overflow: hidden; border:1px solid #cbd5e1; width: 100%; }
  ...
  #tab-data .action-group { display:flex; gap:8px; justify-content:center; }
  #tab-data .icon-btn {
    width:36px; height:36px; border-radius:10px; display:inline-flex; align-items:center; justify-content:center;
    font-size:16px; text-decoration:none; border:1px solid transparent; transition:all .2s ease; color:#fff; cursor: pointer;
  }
  #tab-data .icon-btn:hover { transform: translateY(-1px) scale(1.04); box-shadow: 0 8px 16px rgba(15,23,42,.16); }
  ...
  @media (max-width: 900px) {
    ...
    #tab-data table { min-width: 700px; }
    #tab-data td { padding: 10px 8px; }
    #tab-data thead th { padding: 7px 8px 6px; font-size: 11px; }
    #tab-data .icon-btn { width: 32px; height: 32px; font-size: 14px; }
    #tab-data .score-main { font-size: 14px; }
    #tab-data .score-pill { font-size: 11px; padding: 3px 8px; }
  }
        ...
        <div class="mobile-list">
          <?php foreach ($rowsData as $row): ?>
            ...
            <div class="mobile-item">
              ...
              <div class="mobile-meta"><?= htmlspecialchars($row['nama_petugas_unit']) ?></div>
              <div class="score-wrap">
                <div class="score-head">
