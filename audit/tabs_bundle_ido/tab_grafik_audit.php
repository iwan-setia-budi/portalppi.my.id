...
$judulGrafik = 'Grafik Kepatuhan Bundle IDO di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Bundle IDO di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
...
<div id="tab-grafik" class="tab-pane active">
  ...
  <div class="section-card">
    ...
    <div class="chart-wrap" id="grafikBundleIdoExportWrap">
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', async function () {
        const wrap = document.getElementById('grafikBundleIdoExportWrap');
        ...
        try {
          ...
          const out = await html2canvas(wrap, {
            ...
            onclone: function (doc) {
              const w = doc.getElementById('grafikBundleIdoExportWrap');
              if (w) {
                w.style.borderRadius = '14px';
                w.style.background = '#ffffff';
              }
              const kk = doc.querySelector('#grafikBundleIdoExportWrap .kode-keterangan-wrap');
              if (kk) {
