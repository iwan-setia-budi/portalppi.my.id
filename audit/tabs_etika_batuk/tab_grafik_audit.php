...
$judulGrafik = 'Grafik Kepatuhan Etika Batuk di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Etika Batuk di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
...
<div id="tab-grafik" class="tab-pane active">
  ...
  <div class="section-card">
    ...
    <div class="chart-wrap" id="grafikEtikaBatukExportWrap">
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', async function () {
        const wrap = document.getElementById('grafikEtikaBatukExportWrap');
        const tryCanvasOnly = function () {
          const link = document.createElement('a');
          link.href = chart.toBase64Image('image/png', 1);
          link.download = 'grafik-kepatuhan-etika-batuk.png';
          link.click();
        };
        ...
        try {
          ...
          const out = await html2canvas(wrap, {
            ...
            onclone: function (doc) {
              const w = doc.getElementById('grafikEtikaBatukExportWrap');
              if (w) {
                w.style.borderRadius = '14px';
                w.style.background = '#ffffff';
              }
              const kk = doc.querySelector('#grafikEtikaBatukExportWrap .kode-keterangan-wrap');
              if (kk) {
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-etika-batuk.png';
        link.click();
      });
    }
  })();
