...
$judulGrafik = 'Grafik Kepatuhan Audit Kewaspadaan Transmisi di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Audit Kewaspadaan Transmisi di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', function () {
        ...
        link.download = 'grafik-kepatuhan-kewaspadaan-transmisi.png';
        link.click();
      });
    }
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-kewaspadaan-transmisi.png';
        link.click();
      });
    }
  })();
