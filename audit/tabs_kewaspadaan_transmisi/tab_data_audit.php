...
<div id="tab-data" class="tab-pane active">
  ...
  <div class="section-card">
    <h3 class="card-title">Data Audit Kewaspadaan Transmisi</h3>
              ...
              <tr>
                ...
                <td class="center">
                  <div class="action-group">
                    <a class="icon-btn view" href="crud_kewaspadaan_transmisi/detail_audit.php?id=<?= (int) $row['id'] ?>" title="Lihat detail" aria-label="Lihat detail">👁</a>
                    <a class="icon-btn edit" href="crud_kewaspadaan_transmisi/edit_audit.php?id=<?= (int) $row['id'] ?>" title="Edit data" aria-label="Edit data">✏</a>
                    <?php if ($ppiAuditCanDelete): ?>
                    <a class="icon-btn del" href="crud_kewaspadaan_transmisi/hapus_audit.php?id=<?= (int) $row['id'] ?>" title="Hapus data" aria-label="Hapus data" onclick="return confirm('Yakin hapus data ini?')">🗑</a>
                    <?php endif; ?>
                  </div>
                </td>
              </tr>
          ...
          <?php foreach ($rowsData as $row): ?>
            ...
            <div class="mobile-item">
              ...
              <div class="mobile-actions">
                <a class="icon-btn view" href="crud_kewaspadaan_transmisi/detail_audit.php?id=<?= (int) $row['id'] ?>" title="Lihat detail">👁</a>
                <a class="icon-btn edit" href="crud_kewaspadaan_transmisi/edit_audit.php?id=<?= (int) $row['id'] ?>" title="Edit data">✏</a>
                <?php if ($ppiAuditCanDelete): ?>
                <a class="icon-btn del" href="crud_kewaspadaan_transmisi/hapus_audit.php?id=<?= (int) $row['id'] ?>" title="Hapus data" onclick="return confirm('Yakin hapus data ini?')">🗑</a>
                <?php endif; ?>
              </div>
            </div>
          <?php endforeach; ?>
    ...
    <?php else: ?>
      <div class="empty-state">
        ...
        <strong>Belum ada data audit kewaspadaan transmisi.</strong>
