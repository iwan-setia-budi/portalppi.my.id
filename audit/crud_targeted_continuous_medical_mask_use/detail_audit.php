...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_targeted_continuous_medical_mask_use WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_targeted_continuous_medical_mask_use_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Targeted Continuous Medical Mask Use</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Targeted Continuous Medical Mask Use #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit targeted continuous medical mask use.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_targeted_continuous_medical_mask_use.php?tab=tab-data">Kembali ke Data</a>
