...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_ruang_isolasi WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_ruang_isolasi_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Ruang Isolasi</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Ruang Isolasi #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit ruang isolasi.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_ruang_isolasi.php?tab=tab-data">Kembali ke Data</a>
