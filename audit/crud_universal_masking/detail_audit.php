...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_universal_masking WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_universal_masking_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Universal Masking</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Universal Masking #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit universal masking.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_universal_masking.php?tab=tab-data">Kembali ke Data</a>
