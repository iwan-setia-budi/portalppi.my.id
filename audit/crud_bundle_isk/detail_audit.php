...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_bundle_isk WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_bundle_isk_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Bundle ISK</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Bundle ISK #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit Bundle ISK.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_bundle_isk.php?tab=tab-data">Kembali ke Data</a>
