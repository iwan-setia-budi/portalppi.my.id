...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_praktik_lumbal_fungsi WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_praktik_lumbal_fungsi_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Praktik Lumbal Fungsi</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Praktik Lumbal Fungsi #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit praktik lumbal fungsi.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_praktik_lumbal_fungsi.php?tab=tab-data">Kembali ke Data</a>
