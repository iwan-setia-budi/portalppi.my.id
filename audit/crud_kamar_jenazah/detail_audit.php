...
$qDetail = mysqli_query($conn, "SELECT * FROM detail_audit_kamar_jenazah WHERE audit_id = $id ORDER BY kode_bagian, urutan_item");
$qFoto = mysqli_query($conn, "SELECT * FROM audit_kamar_jenazah_foto WHERE audit_id = $id ORDER BY id DESC");
$statusMessage = '';
...
<head>
  ...
  <title>Detail Audit Kamar Jenazah</title>
  ...
  <div class="layout">
    ...
    <main>
      ...
      <div class="page-wrap">
        ...
        <div class="hero-card">
          <h1>Detail Audit Kamar Jenazah #<?= (int) $audit['id'] ?></h1>
          <p class="subtitle">Ringkasan data audit kamar jenazah.</p>
          <div class="stat-grid">
          ...
          <div class="action-row">
            <a class="btn btn-secondary" href="../audit_kamar_jenazah.php?tab=tab-data">Kembali ke Data</a>
