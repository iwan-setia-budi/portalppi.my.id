...
<div id="tab-rekap" class="tab-pane active">
  ...
  <div class="section-card" id="rekap-bagian-card">
    ...
    <div class="download-toolbar">
      <a class="btn-download-image js-download-image" href="#" data-target-id="rekap-bagian-card" data-file-prefix="rekap_bagian_tps">Download Gambar Rekap Bagian</a>
    </div>
  ...
  <div class="section-card" id="rekap-periode-card">
    ...
    <div class="download-toolbar">
      <a class="btn-download-image js-download-image" href="#" data-target-id="rekap-periode-card" data-file-prefix="rekap_periode_tps">Download Gambar Rekap Periode</a>
    </div>
...
<script>
  (function () {
    ...
    function renderTableDataToCanvas(target) {
      ...
      const title = titleEl ? titleEl.textContent.trim() : 'Rekap Audit TPS';
      if (!tableEl) {
    ...
    document.querySelectorAll('.js-download-image').forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        const filePrefix = btn.getAttribute('data-file-prefix') || 'rekap_tps';
