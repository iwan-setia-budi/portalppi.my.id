...
$judulGrafik = 'Grafik Kepatuhan Audit TPS di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
$judulTren = 'Grafik Tren Kepatuhan Audit TPS di Rumah Sakit Primaya Bhakti Wara - ' . $periodeLabel;
  ...
  (function () {
    ...
    if (btnDownload) {
      btnDownload.addEventListener('click', function () {
        ...
        link.download = 'grafik-kepatuhan-tps.png';
        link.click();
      });
    }
    ...
    if (btnDownloadTren) {
      btnDownloadTren.addEventListener('click', function () {
        ...
        link.download = 'grafik-tren-kepatuhan-tps.png';
        link.click();
      });
    }
  })();
